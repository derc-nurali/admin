...
import { addTag, getTags } from '../../../thunks/news-thunks';
...
export const NewsTags: ComponentType<NewsTagsProps> = ({
  locale,
  onChange,
  ...props
}) => {
  const dispatch = useDispatch();
  const { tags } = useSelector((state: RootStateOrAny) => state[ENTITY_NEWS]);
