...
import { PROJECTS_RESOURCES } from './projects-resource';
...
export const Projects: ComponentType = () => {
  ...
  const {
    ...
    queryCreatedAtFrom,
    columns,
  }: any = useCatalog(PROJECTS_RESOURCES);
  ...
  return (
    <Container>
      <BackButton />
      <PageTitle title={t('projects', 'Проекты')} />
      <Grid container mb={2} columnSpacing={2}>
        ...
        >
          <DataTableCreateButton entity={ENTITY_PROJECT} />
        </Grid>
      </Grid>
      <DataTableBrim
        actions={[
          <DataTableCreateButton entity={ENTITY_PROJECT} variant="small" />,
          <PeriodsSelectForm
